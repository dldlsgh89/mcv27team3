...
public void InsertEmployee(Employee employee) {
	...
	//메게변수 int startRow -> select결과물의 시작행
	//매개변수 int pagePerRow->select 결과물의갯수
	...
	public Employee SelectforUpdate(int employeeNo){
		System.out.println("04 �Ѹ�ȸ�� ��ȸ mSelectforUpdate Mdao.java");
		...
		resultset = preparedstatement.executeQuery();
		if(resultset.next()) {
			System.out.println("���� ���� ��� �ֳ�? mSelectforUpdate Mdao.java");
