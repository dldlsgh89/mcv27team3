...
public class GetTeacherListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		...
		arrayTeacher = teacherDao.selectTeacher(starRow, pagePerRow); //입력받은 starRow번째부터 pagePerRow번 select 해주는 query문을 실행하는 메서드
		
		int totalRowCount = teacherDao.teacherRowCount();  //총게시물수을 구하는 count query을 실행하고 리턴값을 받는 메서드. 
		...
		System.out.println(totalPage+"<------totalPage---GetTeacherListController");
